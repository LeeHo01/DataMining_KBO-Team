...
# ✅ 문항 정의
questions = [
    "본인이 응원하는 팀의 수비력은 얼마나 뛰어나야 한다고 생각하십니까?",
    "본인이 응원하는 팀의 투수력은 얼마나 강해야 한다고 생각하십니까?",
    "본인이 응원하는 팀의 타격력은 얼마나 우수해야 한다고 생각하십니까?",
    "본인이 응원하는 팀의 구장 시설(좌석, 시설 등)은 얼마나 쾌적해야 한다고 생각하십니까?",
    "본인이 응원하는 팀의 구장 내 혹은 구장 주변 먹거리(음식, 간식 등)가 얼마나 있어야 한다고 생각하십니까?",
    ...
    "팀에 내세울 만한 스타선수가 있어야 한다고 생각하십니까?",
    "응원하는 팀 선수들의 외적인 매력(외모, 스타일 등)도 뛰어나야 한다고 생각합니까?",
    "본인이 응원하는 팀의 성적이 좋아야 한다고 생각하십니까?",
    "본인이 응원하는 팀은 전통과 역사가 깊어야 한다고 생각하십니까?",
    "본인이 응원하는 팀의 응원가가 흥겹고 매력적이어야 한다고 생각하십니까?",
    "본인이 응원하는 팀의 치어리더와 응원 무대가 인상적이어야 한다고 생각하십니까?",
    "본인이 응원하는 팀 선수들은 열정적이고 근성이 강해야한다고 생각하십니까?",
